...
function authStateObserver(user) {
  if (user) { // Usuário está autenticado!
   ...
   //     - tornar visível o campo de envio de mensagens
    ...
    let element = document.getElementById("init_screen");
    element.style.display = "none";
    /* let user_name = getUserName();
    let user_img = getProfileImageUrl(); */
    element = document.getElementById("profile_screen");
    element.style.display = "block";
    document.getElementById("user_name").innerHTML = getUserName();
    document.getElementById("user_img").setAttribute("src", getProfileImageUrl());
